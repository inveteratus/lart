        ...
        <div class="bg-slate-100 px-8 py-6 rounded shadow max-w-sm w-full">
            <form method="post" class="flex flex-col space-y-2">
                ...
                <div class="flex flex-col space-y-1">
                    ...
                    <div class="flex flex-col space-y-0.5 w-full">
                        <input id="password" type="password" name="password" class="border border-slate-300 text-sm rounded px-2.5 focus:outline-none focus:border-blue-300 focus:ring-1 focus:ring-blue-300" autocomplete="new-password" required />
                        @error('password')
                            <span class="text-sm text-red-500">{{ $message }}</span>
                        @enderror
                    </div>
